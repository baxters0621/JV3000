...
-- Adaptado para MariaDB (Estructura y datos ordenados correctamente)
...
(2, 'Operador de Carga', 'Gestión de compras, productos, proveedores y categorías', '2026-07-23 21:54:53'),
(3, 'Operador de Ventas', 'Gestión de ventas, reportes y estadísticas', '2026-07-23 21:54:53');
...
INSERT INTO `productos` (`id_producto`, `sku`, `nombre_producto`, `precio_venta`, `precio_costo`, `stock_actual`, `stock_minimo`, `stock_maximo`, `fecha_vencimiento`, `status`, `id_categoria`, `id_proveedor`) VALUES
(1, 'LUB-ACE-0001', 'Aceite Mobil Super 2000 20W-50 1L', 8.50, 5.10, 48, 10, 0, '2026-01-15', 'Activo', 9, 2),
(2, 'LUB-ACE-0002', 'Aceite Castrol GTX 20W-50 1L', 7.80, 4.68, 45, 10, 0, '2026-08-10', 'Activo', 9, 2),
(3, 'LUB-ACE-0003', 'Aceite Shell Helix HX3 20W-50 4L', 28.00, 16.80, 26, 8, 0, '2027-03-15', 'Activo', 9, 2),
(4, 'LUB-ACE-0004', 'Aceite Havoline Pro-DS 15W-40 1L', 9.50, 5.70, 35, 10, 0, '2027-06-10', 'Activo', 9, 2),
(5, 'LUB-ACE-0005', 'Aceite Liqui Moly 5W-30 4L', 52.00, 31.20, 12, 5, 0, '2028-01-20', 'Activo', 9, 2),
(6, 'LUB-TRA-0001', 'Lubricante ATF Dexron III 1L', 11.00, 6.60, 25, 8, 0, '2026-04-20', 'Activo', 10, 2),
(7, 'LUB-TRA-0002', 'Lubricante 90GL-5 1L', 10.50, 6.30, 20, 8, 0, '2029-11-30', 'Activo', 10, 2),
(9, 'LUB-REF-0001', 'Refrigerante Prestone Verde 1L', 7.50, 4.50, 30, 10, 0, '2026-07-28', 'Activo', 11, 2),
(10, 'LUB-REF-0002', 'Refrigerante Havoline Rojo 1L', 8.00, 4.80, 28, 10, 0, '2028-07-05', 'Activo', 11, 2),
(11, 'BAT-AUT-0001', 'Batería Duncan 34R 550CCA', 135.00, 81.00, 15, 5, 0, '2026-07-26', 'Activo', 12, 4),
(12, 'BAT-AUT-0002', 'Batería Bosch S4 60Ah', 175.00, 105.00, 11, 5, 0, '2026-08-18', 'Activo', 12, 4),
(13, 'BAT-AUT-0003', 'Batería Optima YellowTop D31T', 385.00, 231.00, 6, 3, 0, '2029-02-14', 'Activo', 12, 4),
(14, 'FIL-ACE-0001', 'Filtro Aceite Fram PH7317', 9.50, 5.70, 39, 10, 0, '2025-11-10', 'Activo', 18, 1),
(15, 'FIL-ACE-0002', 'Filtro Aceite Bosch 3330', 10.00, 6.00, 35, 10, 0, '2026-08-15', 'Activo', 18, 1),
(16, 'FIL-ACE-0003', 'Filtro Aceite Purolator L14610', 8.00, 4.80, 30, 10, 0, '2030-09-18', 'Activo', 18, 1),
(17, 'FIL-AIR-0001', 'Filtro Aire K&N 33-2456', 62.00, 37.20, 8, 5, 0, '2026-07-25', 'Activo', 19, 1),
(18, 'FIL-AIR-0002', 'Filtro Aire AC-Delco A1512C', 20.00, 12.00, 25, 8, 0, '2030-03-08', 'Activo', 19, 1),
(19, 'FIL-AIR-0003', 'Filtro Aire Fram CA10113', 22.00, 13.20, 22, 8, 0, '2031-07-01', 'Activo', 19, 1),
(20, 'FIL-COM-0001', 'Filtro Combustible WIX 33480', 16.00, 9.60, 20, 5, 0, '2026-08-05', 'Activo', 20, 1),
(21, 'FIL-COM-0002', 'Filtro Combustible Bosch 0450905051', 24.00, 14.40, 18, 5, 0, '2029-08-14', 'Activo', 20, 1),
(22, 'FIL-CAB-0001', 'Filtro Cabina Fram CF10850', 28.00, 16.80, 15, 5, 0, '2030-12-25', 'Activo', 21, 1),
(23, 'FRE-PAS-0001', 'Pastillas Freno Cerámicas Bosch', 55.00, 33.00, 19, 5, 0, '2026-08-12', 'Activo', 22, 3),
(24, 'FRE-PAS-0002', 'Pastillas Freno Orgánicas Ferodo', 45.00, 27.00, 18, 5, 0, '2033-07-30', 'Activo', 22, 3),
(25, 'FRE-PAS-0003', 'Pastillas Freno Semi-metálicas Jurid', 52.00, 31.20, 15, 5, 0, '2032-09-15', 'Activo', 22, 3),
(26, 'FRE-DIS-0001', 'Disco Freno Delantero Brembo', 95.00, 57.00, 11, 5, 0, '2035-04-10', 'Activo', 23, 3),
(27, 'FRE-DIS-0002', 'Disco Freno Trasero ACDelco', 72.00, 43.20, 14, 5, 0, '2034-11-05', 'Activo', 23, 3),
(28, 'FRE-LIQ-0001', 'Líquido Freno DOT 4 Prestone 1L', 10.50, 6.30, 30, 10, 0, '2026-03-05', 'Activo', 24, 3),
(29, 'FRE-LIQ-0002', 'Líquido Freno DOT 5.1 Motul 500ml', 18.00, 10.80, 12, 5, 0, '2028-03-22', 'Activo', 24, 3),
(39, 'ELE-BUJ-0001', 'Bujía NGK Iridium BKR6EIX-11', 18.00, 10.80, 36, 10, 0, '2030-05-22', 'Activo', 26, 4),
(40, 'ELE-BUJ-0002', 'Bujía Bosch Super 4 FR7DC+', 12.00, 7.20, 45, 10, 0, '2031-01-10', 'Activo', 26, 4);
...
INSERT INTO `lotes` (`id_lote`, `id_producto`, `id_proveedor`, `id_compra`, `cantidad`, `cantidad_restante`, `precio_costo`, `fecha_vencimiento`, `fecha_ingreso`) VALUES
(1, 1, 2, NULL, 48, 48, 5.10, '2026-01-15', '2026-07-21 23:33:04'),
(2, 2, 2, NULL, 45, 45, 4.68, '2026-08-10', '2026-07-21 23:33:04'),
(3, 3, 2, NULL, 26, 26, 16.80, '2027-03-15', '2026-07-21 23:33:04'),
(4, 4, 2, NULL, 35, 35, 5.70, '2027-06-10', '2026-07-21 23:33:04'),
(5, 5, 2, NULL, 12, 12, 31.20, '2028-01-20', '2026-07-21 23:33:04'),
(6, 6, 2, NULL, 25, 25, 6.60, '2026-04-20', '2026-07-21 23:33:04'),
(7, 7, 2, NULL, 20, 20, 6.30, '2029-11-30', '2026-07-21 23:33:04'),
(8, 9, 2, NULL, 30, 30, 4.50, '2026-07-28', '2026-07-21 23:33:04'),
(9, 10, 2, NULL, 28, 28, 4.80, '2028-07-05', '2026-07-21 23:33:04'),
(10, 11, 4, NULL, 15, 15, 81.00, '2026-07-26', '2026-07-21 23:33:04'),
(11, 12, 4, NULL, 11, 11, 105.00, '2026-08-18', '2026-07-21 23:33:04'),
(12, 13, 4, NULL, 6, 6, 231.00, '2029-02-14', '2026-07-21 23:33:04'),
(13, 14, 1, NULL, 39, 39, 5.70, '2025-11-10', '2026-07-21 23:33:04'),
(14, 15, 1, NULL, 35, 35, 6.00, '2026-08-15', '2026-07-21 23:33:04'),
(15, 16, 1, NULL, 30, 30, 4.80, '2030-09-18', '2026-07-21 23:33:04'),
(16, 17, 1, NULL, 8, 8, 37.20, '2026-07-25', '2026-07-21 23:33:04'),
(17, 18, 1, NULL, 25, 25, 12.00, '2030-03-08', '2026-07-21 23:33:04'),
(18, 19, 1, NULL, 22, 22, 13.20, '2031-07-01', '2026-07-21 23:33:04'),
(19, 20, 1, NULL, 20, 20, 9.60, '2026-08-05', '2026-07-21 23:33:04'),
(20, 21, 1, NULL, 18, 18, 14.40, '2029-08-14', '2026-07-21 23:33:04'),
(21, 22, 1, NULL, 15, 15, 16.80, '2030-12-25', '2026-07-21 23:33:04'),
(22, 23, 3, NULL, 19, 19, 33.00, '2026-08-12', '2026-07-21 23:33:04'),
(23, 24, 3, NULL, 18, 18, 27.00, '2033-07-30', '2026-07-21 23:33:04'),
(24, 25, 3, NULL, 15, 15, 31.20, '2032-09-15', '2026-07-21 23:33:04'),
(25, 26, 3, NULL, 11, 11, 57.00, '2035-04-10', '2026-07-21 23:33:04'),
(26, 27, 3, NULL, 14, 14, 43.20, '2034-11-05', '2026-07-21 23:33:04'),
(27, 28, 3, NULL, 30, 30, 6.30, '2026-03-05', '2026-07-21 23:33:04'),
(28, 29, 3, NULL, 12, 12, 10.80, '2028-03-22', '2026-07-21 23:33:04'),
(29, 39, 4, NULL, 36, 36, 10.80, '2030-05-22', '2026-07-21 23:33:04'),
(30, 40, 4, NULL, 45, 45, 7.20, '2031-01-10', '2026-07-21 23:33:04');
