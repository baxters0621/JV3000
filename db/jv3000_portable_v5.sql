...
INSERT INTO `roles` VALUES (1,'Administrador','Acceso total al sistema','2026-07-23 21:54:53'),(2,'Operador de Carga','Gestión de compras, productos, proveedores y categorías','2026-07-23 21:54:53'),(3,'Operador de Ventas','Gestión de ventas, reportes y estadísticas','2026-07-23 21:54:53');
INSERT INTO `tipos_movimientos` VALUES (1,'Venta','Salida'),(2,'Mermas','Salida'),(3,'Regalias','Salida'),(4,'Daños','Salida'),(5,'Devoluciones','Entrada'),(6,'Ajuste de Inventario','Entrada'),(7,'Compra','Entrada');
INSERT INTO `configuracion` VALUES (1,'iva_porcentaje','16','Porcentaje de IVA aplicado a las ventas','2026-07-14 19:18:02'),(2,'empresa_nombre','JV3000 C.A.','Nombre de la empresa','2026-07-14 19:18:02'),(3,'empresa_rif','J-50287309-0','RIF de la empresa','2026-07-14 21:18:43'),(4,'empresa_telefono','+58 0414-4014690','Teléfono de la empresa','2026-08-06 01:46:15'),(5,'empresa_direccion','Naguanagua, Edo. Carabobo','Dirección de la empresa','2026-08-08 22:41:40'),(6,'empresa_email','jv3000ca@gmail.com','Correo de la empresa','2026-07-14 21:17:48'),(7,'documentos_normalizados','1','Migracion de formato de documento fiscal aplicada (v1)','2026-08-06 23:31:23');
