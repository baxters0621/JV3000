...
<style>
   ...
   ============================================= */
    ...
    .nav-group.nav-dashboard {
        --mod-color: #94a3b8;
    }

    .nav-group.nav-inventario {
        --mod-color: #38bdf8;
    }

    .nav-group.nav-entradas {
        --mod-color: #22c55e;
    }

    .nav-group.nav-salidas {
        --mod-color: #ef4444;
    }

    .nav-group.nav-clientes {
        --mod-color: #a855f7;
    }

    .nav-group.nav-usuarios {
        --mod-color: #ea580c;
    }

    .nav-group.nav-reportes {
        --mod-color: #f59e0b;
    }
    ...
    .nav-item.nav-usuarios {
        --mod-color: #ea580c;
    }

    .nav-item.nav-estadisticas {
        --mod-color: #14b8a6;
    }
...
<script>
    ...
    function imprimirReporte(e) {
        e.preventDefault();
        window.location.href = '<?php echo $prefijo; ?>modules/reporte_inventario.php';
    }
</script>