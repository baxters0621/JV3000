...
// Las actualizaciones de esquema se ejecutan explícitamente con tools/migrar.php.
// El arranque web no solicita privilegios DDL ni modifica la estructura de la BD.
