                    ...
                    <div class="p-4 modal-producto-edit-body">
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-6">
                                ...
                                <input type="number" class="input-jv" id="edit_pvp" name="precio_venta" step="0.01" min="0.01" max="999999" required>
                            </div>
                            <div class="col-6">
                                <label class="small fw-bold text-secondary mb-1">PRECIO COSTO ($)</label>
                                <input type="number" class="input-jv" id="edit_costo" name="precio_costo" step="0.01" min="0.01" max="999999" required>
                            </div>
                        </div>
                        <div class="row g-2 mb-2">
                            <div class="col-4">
